...
def process_coins():
    ...
    # total += int(input("how many dimes/paise?: ")) * 0.1
...
while is_on:
    ...
    again = input("Would you like to buy another coffee? Type 'y' for yes or 'n' for no.")
    if again == "y":
        continue
    else:
        off = input("Please type 'off' to off the coffee machine.")
